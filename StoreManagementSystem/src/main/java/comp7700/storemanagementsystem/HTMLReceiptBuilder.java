...
public class HTMLReceiptBuilder implements IReceiptBuilder {
    ...
    public void appendCustomer(CustomerModel customer) {
        sb.append("<p><b>Customer ID:</b> " + customer.getCustomer_id()+ "</p>");
        sb.append("<p><b>Name:</b> " + customer.getName() + "</p>");
        sb.append("<p><b>Phone:</b> " + customer.getPhone() + "</p>");
        sb.append("<p><b>Address:</b> " + customer.getAddress() + "</p>");
    }
    ...
    public void appendProduct(ProductModel product) {
        ...
        sb.append("<tr>");
        sb.append("<td> " + product.getProduct_id() + " </td>" );
...
//        sb.append("<hr color=\"red\"  width=\"100%\" >\n");
    ...
    public void appendPurchase(PurchaseModel purchase) {
        sb.append(String.format("<p>                  Subtotal: %8.2f</p>", purchase.getCost()));
        sb.append(String.format("<p>                       Tax: %8.2f</p>", purchase.getTax()));
        sb.append(String.format("<p>                     TOTAL: %8.2f</p>", purchase.getTotal_cost()));
    }
